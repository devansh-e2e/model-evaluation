...
def parse_args(input_args=None):
    ...
    parser.add_argument("--dataset_type", type=str, default="huggingface", help="the dataset source, options: [huggingface, eos_bucket]")
    parser.add_argument("--dataset_bucket_id", type=str, default=None, help="the bucket when dataset type is eos bucket")
    parser.add_argument("--dataset_path", type=str, default=None, help="the bucket path when dataset type is eos bucket")
    parser.add_argument("--dataset_accesskey", type=str, default=None, help="the bucket access key when dataset type is eos bucket")
    parser.add_argument("--dataset_secretkey", type=str, default=None, help="the bucket secret key when dataset type is eos bucket")
